...
Zebrane biblioteki i wybór implementacji modelu pozwalaj¹ na skuteczne przygotowanie danego projektu do wizualizacji [dzia³ \ref{s:model-analysis}]. Kroki potrzebne do wstêpnego przeanalizowania projektu przez Shimmering Constellations opisa³em w tej sekcji.
